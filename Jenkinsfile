pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/RodActual/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('rodrig99-225')   // <---- Change this to match your kubernetes cluster credentials
    }
